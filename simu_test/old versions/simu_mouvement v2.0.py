...
#+ Les chiens arrêtent de focus une brebis quand elle est dans l'enclos
#+ Vue en x et y (Purple)
#
...
def dog_bringer_movement2(dog):
    ...
    for i in range(0, len(SHEEPS_LIST) ):
        ...
        if( abs(dx) < dog.sightx and abs(dy) < dog.sighty ): #Sheep targeting behavior
            ...
            if( distance_sheep_to_sheepfold > sheepfold_radius):
                sheeps_in_sight += 1
